...
import com.hawk.test.zxing.decoding.CaptureActivityHandler;
import com.hawk.test.zxing.decoding.InactivityTimer;
import com.hawk.test.zxing.view.ViewfinderView;

import java.io.IOException;
import java.util.Vector;

/**
 * Created by SEAN on 2015/10/27.
 */
public class CaptureActivity extends Activity implements Callback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.ac_ui_capture);
